...
class Simba_Frame:
    def __init__(self, top=None):
        ...
        self.doSelectedOpButton.configure(
            command=lambda: [Dummy.EarlyAlphaSimdraftMultiPhase_support.doSelectedOps(self.Scrolledlistbox1.curselection()), updateTags()])
        ...
        self.locOutputPathButton1.configure(command=Dummy.EarlyAlphaSimdraftMultiPhase_support.findLocalOutPath)
        ...
        def checkPath():
            if Dummy.EarlyAlphaSimdraftMultiPhase_support.findLocalFilePath():
                self.localGetButton1.configure(state=NORMAL)
                self.inputDirectEnt1.insert(0,Dummy.EarlyAlphaSimdraftMultiPhase_support.localInputPathVar.get())
        ...
        self.localGetButton1.configure(command=Dummy.EarlyAlphaSimdraftMultiPhase_support.getLocalData)
        ...
        def updateTags():
            ...
            if not(('error' in Dummy.EarlyAlphaSimdraftMultiPhase_support.dataSet)or (Dummy.EarlyAlphaSimdraftMultiPhase_support.dataSet == {})):
        ...
        def urlSetEnt():
            Dummy.EarlyAlphaSimdraftMultiPhase_support.urlInputVar.set(Dummy.EarlyAlphaSimdraftMultiPhase_support.buildURL())
        ...
        def setOut():
            Dummy.EarlyAlphaSimdraftMultiPhase_support.urlOutputVar.set(Dummy.EarlyAlphaSimdraftMultiPhase_support.buildUrlOut())
        ...
        def onselect(evt):
            ...
            self.varStorage = Dummy.EarlyAlphaSimdraftMultiPhase_support.updateVarSupport(index)
            for n in Dummy.EarlyAlphaSimdraftMultiPhase_support.updateVarSupport(index):
                self.dataVarBox.insert(0,n.getName())
            #value = w.get(index)
        ...
        self.dataVarBox.place(relx=0.41, rely=0.03, relheight=0.56
                                    , relwidth=0.19)
